...
# Task 3 uses the ranking ("R102_test_ranks.dat") provided by the relevance model (Task 1 & Task 2) and
#    the relevance judgement "Test_benchmark.txt" to calculate Recall and Precision at rank positions and then the average precision.
...
if __name__ == "__main__":
    ...
    #pre-processing documents in Test_set folder
